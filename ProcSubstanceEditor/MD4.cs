...
{
    // Special thanks to Omar from Unity Enterprise Support
    // You helped fix this!

    // From:    https://forum.unity.com/threads/yaml-fileid-hash-function-for-dll-scripts.252075/
    // Someone is a f'cking rockstar. Seriously.
    ...
    public static class FileIDUtil
    {
        ...
        public static int ComputeSubstanceName(string filename)
        {
